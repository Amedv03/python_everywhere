...
def send_data():
    ...
    num_cuenta_data = num_cuenta_data.get()
    debido_data = str(debido.get())
    ...
    newfile = open("solicitud de cheque.txt","w")
    ...
    debito_data.delete(0, END)
    credito_data.delete(0, END)
    solicitado_data.delete(0, END)
    autorizado_data.delete(0, END)
    confeccionado_data.delete(0, END)
...
debido_entry= Entry(textvariable=debito, width="20")
...
debido_entry.place(x=460, y=200)
